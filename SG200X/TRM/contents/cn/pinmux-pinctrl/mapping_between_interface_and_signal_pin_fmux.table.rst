...
.. only:: sg2002
	...
	.. _table_inf_signal_pin_fmux_uart_sg2002:
	.. table:: UART
		:widths: 2 1 1 1 3
...
.. only:: sg2000
	...
	.. _table_inf_signal_pin_fmux_uart_sg2000:
	.. table:: UART
		:widths: 2 1 1 1 3
		...
		+---------+---------+---------+--------+-----------------------+
		| U\      | O       | PWR     | 4      | FMUX_GPIO_R           |
		| ART1_TX |         | _WAKEUP1|        | EG_IOCTRL_PWR_WAKEUP1 |
		|         |         |         |        | 0x0300_1094           |
		+---------+---------+---------+--------+-----------------------+
		| U\      | O       | JTAG    | 6      | FMUX_GPIO_RE          |
		| ART1_TX |         | _CPU_TMS|        | G_IOCTRL_JTAG_CPU_TMS |
		...
		|         |         |         |        | 0x0300_1070           |
		+---------+---------+---------+--------+-----------------------+
		| U\      | I       | VIVO_D4 | 6      | FMUX_GPI              |
		| ART2_CTS|         |         |        | O_REG_IOCTRL_VIVO_D4  |
		|         |         |         |        | 0x0300_114C           |
		+---------+---------+---------+--------+-----------------------+
		| U\      | I       |UART2_CTS| 0      | FMUX_GPI              |
		| ART2_CTS|         |         |        | O_REG_IOCTRL_UART2_CTS|
		|         |         |         |        | 0x0300_10CC           |
		+---------+---------+---------+--------+-----------------------+
		| U\      | O       | VIVO_D3 | 6      | FMUX_GPI              |
		| ART2_RTS|         |         |        | O_REG_IOCTRL_VIVO_D3  |
		|         |         |         |        | 0x0300_1150           |
		+---------+---------+---------+--------+-----------------------+
		| U\      | O       |UART2_RTS| 0      | FMUX_GPI              |
		| ART2_RTS|         |         |        | O_REG_IOCTRL_UART2_RTS|
		|         |         |         |        | 0x0300_10C4           |
		+---------+---------+---------+--------+-----------------------+
		| U\      | I       | UART2_RX| 0      | FMUX_GPI              |
		| ART2_RX |         |         |        | O_REG_IOCTRL_UART2_RX |
		|         |         |         |        | 0x0300_10C8           |
		+---------+---------+---------+--------+-----------------------+
		| U\      | I       | IIC2_SCL| 4      | FMUX_GP               |
		| ART2_RX |         |         |        | IO_REG_IOCTRL_IIC2_SCL|
		|         |         |         |        | 0x0300_10B8           |
		+---------+---------+---------+--------+-----------------------+
		| U\      | I       | I       | 2      | FMUX_GPI              |
		| ART2_RX |         | IC0_SDA |        | O_REG_IOCTRL_IIC0_SDA |
		...
		|         |         |         |        | 0x0300_10D8           |
		+---------+---------+---------+--------+-----------------------+
		| U\      | I       | VIVO_D5 | 6      | FMUX_G                |
		| ART2_RX |         |         |        | PIO_REG_IOCTRL_VIVO_D5|
		|         |         |         |        | 0x0300_1148           |
		+---------+---------+---------+--------+-----------------------+
		| U\      | I       | PW      | 1      | FMUX_GPIO             |
		| ART2_RX |         | R_GPIO1 |        | _REG_IOCTRL_PWR_GPIO1 |
		|         |         |         |        | 0x0300_10A8           |
		+---------+---------+---------+--------+-----------------------+
		| U\      | I       | VIVO_D9 | 7      | FMUX_G                |
		| ART2_RX |         |         |        | PIO_REG_IOCTRL_VIVO_D9|
		|         |         |         |        | 0x0300_1138           |
		+---------+---------+---------+--------+-----------------------+
		| U\      | I       | VIVO_CLK| 7      | FMUX_GP               |
		| ART2_RX |         |         |        | IO_REG_IOCTRL_VIVO_CLK|
		|         |         |         |        | 0x0300_1160           |
		+---------+---------+---------+--------+-----------------------+
		| U\      | O       | UART2_TX| 0      | FMUX_GPI              |
		| ART2_TX |         |         |        | O_REG_IOCTRL_UART2_TX |
		|         |         |         |        | 0x0300_10C0           |
		+---------+---------+---------+--------+-----------------------+
		| U\      | O       | IIC2_SDA| 4      | FMUX_GPI              |
		| ART2_TX |         |         |        | O_REG_IOCTRL_IIC2_SDA |
		|         |         |         |        | 0x0300_10BC           |
		+---------+---------+---------+--------+-----------------------+
		| U\      | O       | IIC0_SCL| 2      | FMUX_GPI              |
		| ART2_TX |         |         |        | O_REG_IOCTRL_IIC0_SCL |
		|         |         |         |        | 0x0300_1070           |
		+---------+---------+---------+--------+-----------------------+
		| U\      | O       | SD1_D2  | 2      | FMUX_G                |
		| ART2_TX |         |         |        | PIO_REG_IOCTRL_SD1_D2 |
		...
		|         |         |         |        | 0x0300_10A4           |
		+---------+---------+---------+--------+-----------------------+
		| U\      | O       | VIVO_D10| 7      | FMUX_GPIO             |
		| ART2_TX |         |         |        | _REG_IOCTRL_VIVO_D10  |
		|         |         |         |        | 0x0300_1134           |
		+---------+---------+---------+--------+-----------------------+
		| U\      | O       | VIVO_D2 | 7      | FMUX_GPIO             |
		| ART2_TX |         |         |        | _REG_IOCTRL_VIVO_D2   |
		|         |         |         |        | 0x0300_1154           |
		+---------+---------+---------+--------+-----------------------+
		| UA\     | I       | MUX     | 1      | FMUX_GPIO_R           |
		| RT3_CTS |         | _SPI1_CS|        | EG_IOCTRL_MUX_SPI1_CS |
		...
		+---------+---------+---------+--------+-----------------------+
		| U\      | O       | ADC3    | 7      | FMUX_G                |
		| ART3_TX |         |         |        | PIO_REG_IOCTRL_ADC3   |
		|         |         |         |        | 0x0300_10F0           |
		+---------+---------+---------+--------+-----------------------+
		| U\      | I       |UART2_CTS| 5      | FMUX_GPI              |
		| ART4_CTS|         |         |        | O_REG_IOCTRL_UART2_CTS|
		|         |         |         |        | 0x0300_10CC           |
		+---------+---------+---------+--------+-----------------------+
		| U\      | O       |UART2_RTS| 5      | FMUX_GPI              |
		| ART4_RTS|         |         |        | O_REG_IOCTRL_UART2_RTS|
		|         |         |         |        | 0x0300_10C4           |
		+---------+---------+---------+--------+-----------------------+
		| U\      | I       |UART2_RX | 5      | FMUX_GPI              |
		| ART4_RX |         |         |        | O_REG_IOCTRL_UART2_RX |
		|         |         |         |        | 0x0300_10C8           |
		+---------+---------+---------+--------+-----------------------+
		| U\      | I       |UART2_TX | 5      | FMUX_GPI              |
		| ART4_TX |         |         |        | O_REG_IOCTRL_UART2_TX |
		|         |         |         |        | 0x0300_10C0           |
		+---------+---------+---------+--------+-----------------------+
...
.. only:: sg2000
	...
	.. _table_inf_signal_pin_fmux_nodie_uart_sg2000:
	.. table:: No-die domain UART
		:widths: 2 1 1 1 3
		...
		|         |         |         |        | 0x0300_1090           |
		+---------+---------+---------+--------+-----------------------+
		| PWR_U\  | I       | UART2_RX| 2      | FMUX_GPIO             |
		| ART1_RX |         |         |        | _REG_IOCTRL_UART2_RX  |
		|         |         |         |        | 0x0300_10C8           |
		+---------+---------+---------+--------+-----------------------+
		| PWR_U\  | O       | UART2_TX| 2      | FMUX_GPIO_R           |
		| ART1_TX |         |         |        | EG_IOCTRL_UART2_TX    |
		|         |         |         |        | 0x0300_10C0           |
		+---------+---------+---------+--------+-----------------------+
